...
def create_args(args=argparse.Namespace()):
    ...
    args.data_path = "gs://bigissue-research/synthetic_small/train/*.tfrecords"
    args.data_path_val = "gs://bigissue-research/synthetic_small/val/*.tfrecords"
    args.data_lines_len = 128
    args.num_lines_pad = 0
    args.num_lines_with_pad = 128
    args.data_seq_len = 2048
    args.data_pad = 1
